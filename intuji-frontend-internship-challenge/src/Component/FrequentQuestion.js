...
const FrequentQuestion = () => {
  ...
  return (
    <div className="py-[80px] relative">
      ...
      <div className="w-full flex justify-between py-10 px-2">
        ...
        <div className="w-[30%] bg-white border-[1px] border-[#CFCFCF] rounded-[10px] p-6 flex flex-col justify-between">
          <div className="flex flex-col justify-center items-center text-center  gap-4 mt-8">
            <img src={msg} alt="" />
