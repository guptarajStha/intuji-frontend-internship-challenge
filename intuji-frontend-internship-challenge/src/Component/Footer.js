...
const Footer = () => {
  return (
    <div className="pt-[80px]">
      <div className="flex gap-28 pb-[35px]">
        <div className="flex flex-col gap-6 w-1/4">
          <h1 className=' font-bold text-[21px'>AR Shakir</h1>
          <p className='text-[16px] font-medium text-[#757095]'>Finance helps companies manage payments easily.</p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex">
            <input type="email" placeholder="Your email address" className="p-3 bg-[#EEEEFF] outline-none"/>
            <button className="bg-[#3734A9] px-6 py-3 text-white">Subscribe</button>
          </div>
